...
export function createProject(projectData: object) {
  // return useFetch(path)
}

export function updateProject(projectId: number, projectData: object) {
  // return useFetch(path)
}

export function deteleProject(projectId: number) {
  // return useFetch(path)
}
