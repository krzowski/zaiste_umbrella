...
interface Props {
  openNewPatternModal: React.MouseEventHandler<HTMLButtonElement>
}

// eslint-disable-next-line arrow-body-style
const PatternsMenu: React.FC<Props> = ({ openNewPatternModal }) => {
  return (
    <div className="page-menu pt40">
      <button type="button" className="d-b m0a" onClick={openNewPatternModal}>
        Add project
      </button>
